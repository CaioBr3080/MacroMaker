...
export const FIELD_HELP = {
  ...
  operation: "Na etapa Definir variável: definir substitui o valor; somar, subtrair e multiplicar calculam a partir do atual. No Token Magic: aplicar adiciona, atualizar altera filtros existentes e remover exige o Filter ID.",
