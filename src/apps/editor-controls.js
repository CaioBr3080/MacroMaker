...
export const FIELD_HELP = {
  ...
  stretchTo: "Estica a animação entre a origem e o destino selecionados.",
  ...
  scale: "Multiplicador de tamanho da animação: 1 = original, 0.5 = metade, 2 = dobro.",
  ...
  rotation: "Rotação em graus. Ex.: 90 gira um quarto de volta.",
